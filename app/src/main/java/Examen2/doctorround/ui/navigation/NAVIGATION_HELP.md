...
interface NavigationDestination {
    ...
    /**
     * ID del recurso de texto que se mostrará en la TopAppBar (ej: R.string.app_name). ¡Ojo en el detalle del plato mostramos 
     * el nombre del plato que no es un texto estático! Por simplicidad se puede manejar en la lógica del TopAppBar --> Si estoy 
     * en home screen uso titleRes (R.string...) else (detalle) leo título del ViewModel
     */
    val titleRes: Int
}
```
...
Crea un objeto (Singleton) para cada pantalla de tu app. En Kotlin podemos tener todos estos objetos en el mismo file .kt, 
ventajas de Kotlin. Esto evita escribir strings a mano ("strings mágicas") y cometer errores tipográficos.
