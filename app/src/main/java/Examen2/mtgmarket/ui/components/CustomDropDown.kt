...
/**
* @param selectedValue El valor (opción) que está actualmente seleccionado y se muestra en el campo de texto.
* @param options La lista de `String` que se mostrarán como opciones en el menú desplegable.
* @param label El texto que se mostrará como etiqueta flotante en el `OutlinedTextField`.
* @param onValueChangedEvent La función lambda (callback) que se invoca cuando el usuario selecciona una nueva opción del menú. Recibe la opción seleccionada como parámetro.
* @param modifier El [Modifier] que se aplicará al `ExposedDropdownMenuBox` para personalizar su apariencia o comportamiento.
*/
...
private fun EjemploDropdownMenu() {
